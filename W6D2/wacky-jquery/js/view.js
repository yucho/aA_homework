...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $('ul.group:nth-child(2n) li:nth-child(2n-1)').text('Yucho');
  $('ul.group:nth-child(2n-1) li:nth-child(2n)').text('Yucho');
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $('#easel').on('click', 'li', (e) => {
    if($('#easel li').is(e.currentTarget)) {
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  $('.square').each((_, square) => $(square).css('background-color', window._randomColorString()));
};
